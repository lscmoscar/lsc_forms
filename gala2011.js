$(document).ready(function() {
	...
	$("#numberofraffle20").live('change', function() {
	...
	$("#numberofraffle50").live('change', function() {
	...
	$("#numberofticket1000").live('change', function() {
	...
	$("#numberofticket500").live('change', function() {
	...
	$("#container input:text").focus(function() {
		...
		} else $(this).parent().addClass("highlight");
	});
	...
	$("#reset").click(function() {
		...
		if (ph_type.val() == "") ph_type.val($('option:first', ph_type).val());
		else {
		...
		var state = $('#state');
		if (state.val() == "") state.val($('option:first', state).val());
		else {
